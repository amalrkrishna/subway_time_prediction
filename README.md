...
❌    **Failed to get seasonality in weather patterns** -  As my original data-set was collected just over a week, it fails to account for the climate changes thoriugh out the year, which is an important aspect of travel time predictions.  
